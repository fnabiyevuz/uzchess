...
from apps.users.api_endpoints.reset_password.VerifyCode.serializers import \
...
class VerifyCodeAPIView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if code != cache_data["code"]:
            ...
            return Response(data={"error": _("Incorrect code!")}, status=status.HTTP_400_BAD_REQUEST)
        ...
        return Response(data={"message": _("Confirmed successfully!")}, status=status.HTTP_200_OK)
