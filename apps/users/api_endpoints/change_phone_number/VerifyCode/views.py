...
from apps.users.api_endpoints.change_phone_number.VerifyCode.serializers import \
...
class VerifyCodeAPIView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response(data={"message": _("Your phone number changed successfully")}, status=status.HTTP_200_OK)
